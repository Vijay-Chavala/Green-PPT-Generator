  ...
  const generatePresentation = () => {
    ...
    lines.forEach((line) => {
      ...
      slide.addText("PGF Telugu Church Bangalore", {
        x: "45%", // Center horizontally
        y: "52%", // Adjust the vertical position as needed
        fontSize: 12,
        fontFace: "Microsoft YaHei UI", // Adjust the font face as needed
        align: "center", // Center the text horizontally
        color: "#ffffff", // White color in hexadecimal
        bold: true, // Make the text bold
        underline: true, 
        outline: { color: "#000000", size: 0.1 }, // Stroke with black color and 0.8 size
        h: 0.5, // Adjust the height to control the length of the underline
      });
